...
tab_lists.forEach(function(list){
  list.addEventListener("click", function(){
    ...
    function handleEnter(event) {// Mencegah form submit secara default
        ...
        fetch('<?php echo e(route('search_submit')); ?>', {
        method: 'POST',
        headers: headers,
    ...
    $(document).ready(function() {
        var error = "<?php echo e(session('errors.message')); ?>";
...
<?php /**PATH D:\Laravel Project\mahasiswa_katalog\resources\views/FrontHome/layout/scripts_footer.blade.php ENDPATH**/ ?>