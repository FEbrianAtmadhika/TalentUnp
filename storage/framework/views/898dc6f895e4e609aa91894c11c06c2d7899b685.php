                  ...
                  <div class="row g-2">
                    <div class="col-md-8 col-lg-6 co-sm-10 p-5">
                      <div class="card-body" >
                        ...
                        <form method="POST" action="<?php echo e(route('register_submit')); ?>" enctype="multipart/form-data" style="font-size: 20px">
                          <?php echo csrf_field(); ?>
                          <div class="mb-3">
...
<?php /**PATH D:\Laravel Project\mahasiswa_katalog\resources\views/FrontHome/contak.blade.php ENDPATH**/ ?>