                  ...
                  <div class="row g-2">
                      ...
                      <div class="card-left text-white" style=" background: #280ef100; background-size: cover;">
                        ...
                        <div class="card-body">
                          <div class="text-center p-5">
                            <img src="<?php echo e(asset('img/logounp.png')); ?>" alt="" style="width: 45%; height:45%">
                            <h4>INFORMASI</h4>
                    ...
                    <div class="col-md-8 col-lg-6 co-sm-10 p-5">
                      <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('register_submit')); ?>" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                          <div class="mb-3">
                    ...
                    <p class="text-center text-muted mt-3 mb-0">Sudah memiliki akun? <a href="<?php echo e(route('user_login')); ?>"
...
<?php /**PATH D:\Laravel Project\mahasiswa_katalog\resources\views/FrontHome/User/register.blade.php ENDPATH**/ ?>