<footer class="sticky-footer mt-5">
  <div class="container-fluid text-white">
    <div style="padding-left: 20px; padding-right: 20px;">
      <div class="text-black" style="background-color: #2F58CD ">
        <br>
        <div class="container">
          <div class="box" style="padding-top: 30px">
            <div class="row">
              <div class="col-md-6 col-lg-4">
                ...
                <h5 class=" mb-2 " style="font-weight: bold; font-size: 30px;"><img src="<?php echo e(asset('img/logounp.png')); ?>" alt="" class="img-fluid" width="50px" height="50px"> Talent UNP</h5>
                <p class=" " style="font-size: 24px;"> Mengumpulkan Bakat Terbaik <br> Universitas Negeri Padang</p>
                <br>
            </div>
            <div class="col-md-6 col-lg-2">
              <p class="color-base mb-2" style="font-weight:bold; font-size: 24px;">Help</p>
              <a class=" btn text-white" href="/" style="font-size: 20px; ">Home</a>
              <br>
              <a class="btn text-white" href="" style="font-size: 20px; ">Find Talent</a>
          </div>
          <div class="col-md-6 col-lg-2">
            ...
            <a class="btn text-white" href="" style="font-size: 20px;">Find Talent</a>
              ...
              <div class="col-md-6 col-lg-3">
                ...
                <p style="font-size: 20px;" class="color-base "><i class="fa fa-phone p-md-1"></i>+62
                    831-7061-0000</p>
                <p style="font-size: 20px;" class="color-base "><i class="fa fa-envelope p-md-1"></i>loremipsum@gmail.com</p>
            </div>
          </div>
          <div class="row">
        ...
        <div class="px-5"> <hr style="height: 3px; background-color: white;"></div>
          ...
          <div class="container fluid text-center">
                  ...
                  <h5 style="font-size: 24px">Copyright &copy; Talent UNP</h5>
                  <br>
          </div>
    </div>
    </div>
...
<?php /**PATH D:\Laravel Project\mahasiswa_katalog\resources\views/FrontHome/layout/footer.blade.php ENDPATH**/ ?>