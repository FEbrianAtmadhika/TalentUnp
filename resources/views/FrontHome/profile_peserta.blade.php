          ...
          <div class="card-body">
            ...
            <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
              ...
              <h6 style="font-size: 22px; font-family: 'Times New Roman', Times, serif;">&ensp; {{ $data->no_telp }}</</h6>
                ...
                <div class="p-3">
                  <a href="{{route('user_pesan', $data->id) }}" class="btn text-white w-25 " style="background: #288F8B">Kirim pesan</a>
                </div>
          </div>
