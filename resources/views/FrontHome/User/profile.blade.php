...
<div class="container " style="padding-top:150px;display: flex; justify-content: center;align-items: center;">
  ...
  <div class=" p-5 text-center p-sm-2 p-md-2" >
    ...
    class="img-fluid rounded-circle ratio-1x1 w-50" src="{{$data->photo ? asset('storage/public/img/'.$data->id.'/'.$data->photo) : asset('img/hu.JPG')}}" alt=""/>
   <br><br>
      <h2 style="font-family: 'Times New Roman', Times, serif; font-size: 1.e8m; font-weight: bolder;">{{ $data->name }}</h2>

      <h2 style="font-size: 24px font-family: 'Times New Roman', Times, serif;font-size:1.4em ;color: #03a9f4;font-weight: bold;"> {{ $data->Professi }}</h2>
<br>
<div class="d-flex justify-content-center">
  <div class="box tex-center px-3">
 <a href="https://wa.me/{{ $data->no_telp }}?text=Hai%20{{ $data->name }}" class="btn btn-outline-dark" style="box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23);border-radius: 50%; width: 50px;height: 50px;justify-content: center; display: flex;align-items: center;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
          ...
          <div class="card-body">
            ...
            <hr>
                <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
                  ...
                  <h6 style="font-size: 22px; font-family: 'Times New Roman', Times, serif;">&ensp; {{ $data->name }}</</h6>
                </div>
                </div>
              </div>
              <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
                <div class="d-flex flex-row bd-highlight align-items-center px-2">
                  ...
                  <div class="p-2 bd-highlight py-2">
                <h5 style="font-family: 'Times New Roman', Times, serif;" ><b><u>@if($data->Professi = "Mahasiswa")NIM
                  @else
                  NIP
                  @endif
                </u></b></h5>
                <h6 style="font-size: 22px; font-family: 'Times New Roman', Times, serif;">&ensp; {{ $data->np }}</</h6>
              </div>
              </div>
            </div>
              <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
            ...
            <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
              ...
              <h6 style="font-size: 22px; font-family: 'Times New Roman', Times, serif;">&ensp; {{ $data->Professi }}</</h6>
            </div>
            </div>
          </div>
            <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
              ...
              <h6 style="font-size: 22px; font-family: 'Times New Roman', Times, serif;">&ensp; {{ $data->no_telp }}</</h6>
            </div>
            </div>
          </div>
                <div class="p-3">
                  <a href="{{route('user_edit') }}" class="btn text-white w-25 " style="background: #288F8B">update</a>
                </div>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
              <div class="d-flex flex-row bd-highlight align-items-center px-2">
                ...
                <div class="p-2 bd-highlight py-2">
              <h5 style="font-family: 'Times New Roman', Times, serif;" ><b>{{ $item }}</b></h5>
            ...
            <hr>
              ...
              <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
                <div class="d-flex mb-3 align-items-center py-2 px-2">
                  ...
                  <div class="py-2">
                <h4 style="font-family: 'Times New Roman', Times, serif;" ><b>{{ $item->nama_talent }}</b></h4>
              </div>
              <div class="ms-auto ">
                <a href="{{ route('user_del_skill',  $item->id) }}" class="text-decoration-none btn " type="button" >
            ...
            <hr>
              ...
              <div class="box mx-3 " style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
                <div class="d-flex mb-3 align-items-center py-2 px-2">
                  ...
                  <div class="py-2">
                    <a href="{{ route('view_pdf',  $item->id) }}"class="text-decoration-none">
                <h4 style="font-family: 'Times New Roman', Times, serif; color: black" ><b>{{ $item->judul }}</b></h4><a>
              </div>
              <div class="ms-auto ">
                <a href="{{ route('user_del_sertifikat',  $item->id) }}" class="text-decoration-none btn " type="button" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
                  </svg>
                </a>
  ...
  <div class="container p-5">
    <div class="card " style="background: rgb(154, 101, 101)">
      ...
      <div class="card-body">
        ...
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magnam, rem unde facere veritatis delectus qui consequuntur sequi natus dolor tenetur itaque deserunt quisquam ut, quis fuga aperiam repellendus accusantium! Dolores.</p>
      </div> --}}
      <nav>
          ...
          <div class="box" style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)">
            ...
            <div class="row g-0">
              <div class="col-md-4 py-1 px-2 " style="width: 100px;">
                <a href="" class=""> <img src="{{ asset('img/hu.JPG') }}" alt="" class="ratio ratio-1x1  rounded-circle"></a>
              </div>
              <div class="col-md-8">
                <div class="card-body">
...
<div class="">
  ...
  {{-- <div class="container ">
    <div class="card border border-3 p-5" style="background: #0940da00; border:#4258cf">
  ...
  <div class="modal fade" style=" box-shadow: 0 15px 25px rgba(0, 0, 0, 0.1);backdrop-filter: blur(15px);border-bottom: 3px solid rgb(79, 78, 78)" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('user_add_skill') }}" method="POST">
                @csrf
...
<div class="modal fade" id="addSertifikat" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Example split danger button -->
            <form action="{{ route('user_add_sertifikat') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
